			...
			<c:forEach var="book" items="${searchBookList}">
				<li class="scrolling" data-num="${book.ROWNUM}">
					<div class="info_box">
							...
							<button class="comment_btn" data-title="${book.title}" data-comment="${book.content}">
	                    ...
	                    if(data != ""){
	                        ...
	                        $(data).each(
	                            ...
	                            function(){
	                            	...
	                            	var comment_btn = $("<button class='comment_btn'>");
	                            	...
	                            	wish_btn.append(heart_icon).text("보고싶어요");
	                              	comment_btn.append(comment_icon).text("코멘트쓰기");
							...
							if ($(this).hasClass("true")) {
								...
								if (result) {
									...
									if ($('#inputText').data('comment') != ""
											|| $(this).closest('.info_box')
													.find('.comment_btn').data(
															"comment") != "") {
