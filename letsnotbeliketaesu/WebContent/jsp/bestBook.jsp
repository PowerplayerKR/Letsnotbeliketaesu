					...
					<div id="comment_content_wrap_star_grade_wrap">
						...
						<div id="comment_content_wrap_star_grade_body">
							...
							<div id="comment_content_wrap_star_grade_body_bottom_text">
								<h4 style="text-align: center; margin-bottom: 15px; margin-top: 17px;">댓글
									달려면 별점 클릭
								</h4>
							</div>
...
<div class="book_wrap">
	<c:forEach var="book"  items="${bestBookList}">
	    <div class="book_info_wrap" data-num="${book.num }">
	        ...
	        <div class="book_info">	
	            <h5 class="book_title_info"><a class="book_title_link">${book.title}</a></h5>
	        ...
	        if ($(window).scrollTop() >= ($(document).height() - $(window).height()) ){ //② 현재스크롤의 위치가 화면의 보이는 위치보다 크다면
	            ...
	            $.ajax({
					...
					var info_box = $("<div class='info_box'> <button style='top:-180px;background:none;right:30px;height: 30px;width: 40px;' class='ban_btn' data-isbn='"+this.isbn+"'><i class='fa fa-ban fa-2x' ></i></button>");
	                                ...
	                                var info_wrap = $("<div class='info_wrap'>");
	                                ...
	                                var info = book_info.append(book_title,publisher,detail);
	                      			...
	                      			var info_wrap = $("<div class='info_wrap'>").append(book_img_wrap,info_box);
