...
">본책 확실함?</h5>
	...
	<div id="wrap">
		...
		<div id="content">
			<ul class="book_wrap" >
				<c:forEach var="book" items="${mypage}">
					<li class="book_list" data-title="${book.title}" data-isbn="${book.isbn}">
...
<div id="userpage" style="position: absolute;top: 125px;">
	<a id="see" href="mypage1.do" style="margin-left: 600px;">보고싶어요</a>
	<a id="saw" href="mypage2.do" style="margin-left: 30px;">봤어요</a>
	<a id="interested" href="mypage3.do" style="margin-left: 30px;">관심없어요</a>
<p id="songeunBar" style="width: 80px;height: 10px; background-color: aqua; margin-left: 800px;"></p>
</div>
